...
public class VoteMainCopy {
    ...
    // 생성자 추가
    public VoteMainCopy(Scanner sc) {
        this.sc = sc;
        vdao = new VoteDAO();
        sdao = new SurveyDAO();
    }
    ...
    public void check(){
        ...
        System.out.println("회원 아이디 \t: "+vvo.getId());
        System.out.print("설문조사 번호를 입력하세요\t: ");
        int vno=sc.nextInt();sc.nextLine();
        vvo=vdao.select(vvo.getId(),vno);
    ...
    public void list(){
        System.out.println("----------------------------------------");
        System.out.println("ㅁ VOTE only SYSTEM ㅁㅁㅁㅁㅁㅁㅁㅁ LIST");
        System.out.println("----------------------------------------");
        VoteVO vvo=new VoteVO();
        ...
        System.out.println("----------------------------------------");
        List<VoteVO> vvoList=vdao.selectAll(vvo.getId());
        for(VoteVO vvo1:vvoList){
            System.out.println(vvo1.getSurveyNo() +" | "+vvo1.getOneTwo()+" | "+vvo1.getVoteDate());
        }
    ...
    public static void main(String[] args) {
        ...
        vdao = new VoteDAO();
        sdao=new SurveyDAO();
//        VoteMainCopy v = new VoteMainCopy();
//        v.menu();
